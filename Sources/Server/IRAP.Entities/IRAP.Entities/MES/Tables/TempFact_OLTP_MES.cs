...
{
    [Serializable]
    [IRAPDB(TableName = "IRAPMES..TempFact_OLTP")]
    public class TempFact_OLTP_MES
    {
        [IRAPKey]
        ...
        public TempFact_OLTP_MES Clone()
        {
            return MemberwiseClone() as TempFact_OLTP_MES;
        }
    }
}
