    ...
    public class IRAPMES : IRAPBLLBase
    {
            ...
            out string errText)
        {
            ...
            try
            {
                ...
                paramList.Add(new IRAPProcParameter("@PWONo", DbType.String, pwoNo));
                paramList.Add(new IRAPProcParameter("@QCStatus", DbType.Int32, qcStatus));
                paramList.Add(new IRAPProcParameter("@RSFactXML", DbType.String, rsFactXML));
                paramList.Add(new IRAPProcParameter("@SysLogID", DbType.Int64, sysLogID));
                paramList.Add(new IRAPProcParameter("@ErrCode", DbType.Int32, ParameterDirection.Output, 4));
                paramList.Add(new IRAPProcParameter("@ErrText", DbType.String, ParameterDirection.Output, 400));
                WriteLog.Instance.Write(
                    string.Format(
                        "执行存储过程 IRAPMES..usp_SaveFact_BatchManualInspecting，参数：" +
                ...
                {
                    IRAPError error =
                        conn.CallProc("IRAPMES..usp_SaveFact_BatchManualInspecting", ref paramList);
                    errCode = error.ErrCode;
                    errText = error.ErrText;
                    return Json(error);
                }
            ...
            catch (Exception error)
            {
                ...
                errText =
                    string.Format(
                        "调用 IRAPMES..usp_SaveFact_BatchManualInspecting 函数发生异常：{0}",
                        error.Message);
                return Json(
                    new IRAPError()
                    {
        ...
        /// <param name="errText"></param>
        /// <returns></returns>
        public IRAPJsonResult usp_SaveFact_BatchInspectingConfirm(
            int communityID,
            long factID,
            int t102LeafID,
            int t107LeafID,
            ...
            out string errText)
        {
            ...
            try
            {
                ...
                WriteLog.Instance.Write(
                    string.Format(
                        "执行存储过程 IRAPMES..usp_SaveFact_BatchInspectingConfirm，参数：" +
                        "CommunityID={0}|FactID={1}|T102LeafID={2}|T107LeafID={3}|" +
                ...
                {
                    IRAPError error =
                        conn.CallProc("IRAPMES..usp_SaveFact_BatchInspectingConfirm", ref paramList);
                    errCode = error.ErrCode;
                    errText = error.ErrText;
                    return Json(error);
                }
            ...
            catch (Exception error)
            {
                ...
                errText =
                    string.Format(
                        "调用 IRAPMES..usp_SaveFact_BatchInspectingConfirm 函数发生异常：{0}",
                        error.Message);
                return Json(
                    new IRAPError()
                    {
            ...
            out string errText)
        {
            ...
            try
            {
                ...
                {
                    IRAPError error =
                        conn.CallProc("IRAPMES..usp_SaveFact_SmeltBatchInspecting", ref paramList);
                    errCode = error.ErrCode;
                    errText = error.ErrText;
                    return Json(error);
                }
            ...
            catch (Exception error)
            {
                ...
                errText =
                    string.Format(
                        "调用 IRAPMES..usp_SaveFact_SmeltBatchInspecting 函数发生异常：{0}",
                        error.Message);
                return Json(
                    new IRAPError()
                    {
