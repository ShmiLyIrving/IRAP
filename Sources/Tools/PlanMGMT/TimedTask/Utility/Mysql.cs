...
namespace PlanMGMT
{
    public class Mysql
    {
        ...
        private string connectionString = "server=192.168.57.219;port=3306;user=irap;password=irap;database=plan;Convert Zero Datetime=True;Allow Zero Datetime=True";
        #region 单一实例
        /// <summary>
        /// 
        /// </summary>
        ...
        /// <returns></returns>
        public int ExecuteProcS(string name, MySqlParameter[] paras)
        {
