    ...
    public class HookHelper
    {
        ...
        private int KeyboardHookProc(int nCode, Int32 wParam, IntPtr lParam)
        {
            if (nCode >= 0 && wParam == WM_KEYDOWN || wParam == WM_SYSKEYDOWN)
            {
                ...
                if (
                    (currentKey == Keys.F4 && (int)System.Windows.Forms.Control.ModifierKeys == (int)Keys.Alt)//Alt+F4
                    || (currentKey == Keys.Tab && (int)System.Windows.Forms.Control.ModifierKeys == (int)Keys.Alt)//Alt+Tab
                    || (currentKey == Keys.LWin && (int)System.Windows.Forms.Control.ModifierKeys == (int)Keys.R)//徽标+R
                    )
                {
