...
namespace IRAPPrinterServer
{
    static class Program
    {
        ...
        static void Main()
        {
            ...
            if (WriteLog.Instance.IsWriteLog != SystemParams.Instance.WriteLog)
                WriteLog.Instance.IsWriteLog = SystemParams.Instance.WriteLog;
            ...
            WriteLog.Instance.Write(
                string.Format("运行 IRAP Printer Server (V {0})", "6.1"),
                strProcedureName);
            ...
            try
            {
                ...
                Application.Run(new frmPrinterServerMain());
            }
            ...
            {
                WriteLog.Instance.Write("退出 IRAP Printer Server", strProcedureName);
