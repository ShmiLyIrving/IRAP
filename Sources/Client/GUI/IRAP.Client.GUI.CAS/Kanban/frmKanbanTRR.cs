...
{
    public partial class frmKanbanTRR : IRAP.Client.Global.GUI.frmCustomKanbanBase
    {
        private string className =
             MethodBase.GetCurrentMethod().DeclaringType.FullName;
        private List<Entity.FVS.AndonEventKanbanTRR> events =
                           new List<Entity.FVS.AndonEventKanbanTRR>();
        public frmKanbanTRR()
        {
            InitializeComponent();
        }
        private void GetEvents()
        {
            ...
            try
            {
                ...
                try
                {
                    IRAPFVSClient.Instance.ufn_GetAndonEventKanban_TRR(
        ...
        private void frmKanbanTRR_Activated(object sender, EventArgs e)
        {
