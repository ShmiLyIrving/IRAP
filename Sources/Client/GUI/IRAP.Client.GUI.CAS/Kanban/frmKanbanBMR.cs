...
{
    public partial class frmKanbanBMR : IRAP.Client.Global.GUI.frmCustomKanbanBase
    {
        private string className =
             MethodBase.GetCurrentMethod().DeclaringType.FullName;
        List<Entity.FVS.AndonEventKanbanBMR> events =
                           new List<Entity.FVS.AndonEventKanbanBMR>();
        public frmKanbanBMR()
        {
            InitializeComponent();
        }
        ...
        private void GetEvents()
        {
            ...
            try
            {
                ...
                try
                {
                    IRAPFVSClient.Instance.ufn_GetAndonEventKanban_BMR(
        ...
        public void frmKanbanBMR_Activate(object sender, EventArgs e)
        {
