...
{
    public partial class frmKanbanLSR : IRAP.Client.Global.GUI.frmCustomKanbanBase
    {
        private string className =
             MethodBase.GetCurrentMethod().DeclaringType.FullName;
        List<Entity.FVS.AndonEventKanbanLSR> events =
                           new List<Entity.FVS.AndonEventKanbanLSR>();
        public frmKanbanLSR()
        {
            InitializeComponent();
        }
        private void GetEvents()
        {
            ...
            try
            {
                ...
                try
                {
                    IRAPFVSClient.Instance.ufn_GetAndonEventKanban_LSR(
        ...
        private void frmKanbanLSR_Activated(object sender, EventArgs e)
        {
            ...
            {
                AddLog(new AppOperationLog(DateTime.Now, -1, "没有正确的传入菜单参数!"));
                timer.Enabled = false;
                return;
            }
        }
