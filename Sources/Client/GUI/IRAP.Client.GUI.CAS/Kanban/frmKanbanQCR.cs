...
{
    public partial class frmKanbanQCR : IRAP.Client.Global.GUI.frmCustomKanbanBase
    {
        private string className =
             MethodBase.GetCurrentMethod().DeclaringType.FullName;
        List<Entity.FVS.AndonEventKanbanQCR> events =
                           new List<Entity.FVS.AndonEventKanbanQCR>();
        public frmKanbanQCR()
        {
            InitializeComponent();
        }
        private void GetEvents()
        {
            ...
            try
            {
                ...
                try
                {
                    IRAPFVSClient.Instance.ufn_GetAndonEventKanban_QCR(
        ...
        private void frmKanbanQCR_Activated(object sender, EventArgs e)
        {
