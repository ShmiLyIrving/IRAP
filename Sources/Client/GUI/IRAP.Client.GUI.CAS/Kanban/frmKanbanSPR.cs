...
{
    public partial class frmKanbanSPR : IRAP.Client.Global.GUI.frmCustomKanbanBase
    {
        private string className =
             MethodBase.GetCurrentMethod().DeclaringType.FullName;
        List<Entity.FVS.AndonEventKanbanSPR> events =
                           new List<Entity.FVS.AndonEventKanbanSPR>();
        public frmKanbanSPR()
        {
            InitializeComponent();
        }
        ...
        private void GetEvents()
        {
            ...
            try
            {
                ...
                try
                {
                    IRAPFVSClient.Instance.ufn_GetAndonEventKanban_SPR(
        ...
        private void frmKanbanSPR_Activated(object sender, EventArgs e)
        {
