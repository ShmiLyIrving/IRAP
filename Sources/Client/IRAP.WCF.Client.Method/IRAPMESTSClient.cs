...
namespace IRAP.WCF.Client.Method
{
    public class IRAPMESTSClient
    {
        ...
        public void ufn_GetKanban_Symbols_Inspecting(
            int communityID,
            long sysLogID,
            int productLeaf,
            int workUnitLeaf,
            ref List<PCBSymbols> datas,
            out int errCode,
            out string errText)
        {
            ...
            try
            {
                ...
                WriteLog.Instance.Write(
                    string.Format(
                        "调用 ufn_GetKanban_Symbols_Inspecting，输入参数：" +
                ...
                using (WCFClient client = new WCFClient())
                {
                    object rlt = client.WCFRESTFul(
                        ...
                        "ufn_GetKanban_Symbols_Inspecting",
                        hashParams,
                        out errCode,
                        out errText);
                    WriteLog.Instance.Write(
